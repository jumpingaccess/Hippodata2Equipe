        ...
        competitors.each do |competitor|
          ...
          if horse_fei_id && !existing_horses[horse_fei_id]
            ...
            new_horses << {
              ...
              'name' => horse['HNAME'] || '',
              'sex' => sex,
              'born_year' => (horse_info['BORNYEAR'] || '').to_s,
          ...
          if rider_fei_id && horse_fei_id
            sort_order = competitor.dig('SORTROUND', 'ROUND1') || competitor['SORTORDER'] || 0
            ...
            if is_team_competition && nation.present? && teams_by_nation[nation]
              start_entry['category'] = 'H'
              start_entry['section'] = 'A'
              start_entry['team'] = { 'foreign_id' => teams_by_nation[nation]['foreign_id'] }
              start_entry['club'] = { 'foreign_id' => "club_#{nation}" }
            end
    ...
    competitions.each do |comp|
      ...
      begin
        ...
        competitors.each do |competitor|
          ...
          next unless rider_fei_id && horse_fei_id
